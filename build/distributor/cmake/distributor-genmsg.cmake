...
set(MSG_I_FLAGS "-Idistributor:/home/alaa/rov19_ws/src/distributor/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/alaa/rov19_ws/src/distributor/msg/rov_msgs.msg" NAME_WE)
add_custom_target(_distributor_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "distributor" "/home/alaa/rov19_ws/src/distributor/msg/rov_msgs.msg" ""
)
...
_generate_msg_cpp(distributor
  "/home/alaa/rov19_ws/src/distributor/msg/rov_msgs.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/distributor)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/distributor\")")
  # install generated code
  install(
