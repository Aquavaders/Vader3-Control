...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/alaa/rov19_ws/src/pid)
  set(pid_DEVEL_PREFIX /home/alaa/rov19_ws/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/alaa/rov19_ws/install)
...
if(NOT "/home/alaa/rov19_ws/devel/include;/home/alaa/rov19_ws/src/pid/include " STREQUAL " ")
  set(pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/alaa/rov19_ws/devel/include;/home/alaa/rov19_ws/src/pid/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alaa/rov19_ws/src/pid/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT pid_NUM_DUMMY_TARGETS)
      set(pid_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pid::wrapped-linker-option${pid_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pid_NUM_DUMMY_TARGETS "${pid_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pid::wrapped-linker-option${pid_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pid_LIBRARIES "${interface_target_name}")
...
set(pid_EXPORTED_TARGETS "pid_gencfg")
